class ConfluenceCli < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/rvben/confluence-cli/releases/download/v0.1.1/confluence-cli-v0.1.1-aarch64-apple-darwin.tar.gz"
      sha256 "e5d2d4a6ce3b1053135d85060859578bd2873e4cd1725e7a72c558e39190983e"
    else
      url "https://github.com/rvben/confluence-cli/releases/download/v0.1.1/confluence-cli-v0.1.1-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/rvben/confluence-cli/releases/download/v0.1.1/confluence-cli-v0.1.1-x86_64-unknown-linux-gnu.tar.gz"

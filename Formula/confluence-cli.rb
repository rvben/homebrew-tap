class ConfluenceCli < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/rvben/confluence-cli/releases/download/v0.1.0/confluence-cli-v0.1.0-aarch64-apple-darwin.tar.gz"
      sha256 "9c3527f06d9f4ae0b9c0f1d86561ab36142bb691075d0b56791a2b2d83e9ca5c"
    else
      url "https://github.com/rvben/confluence-cli/releases/download/v0.1.0/confluence-cli-v0.1.0-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/rvben/confluence-cli/releases/download/v0.1.0/confluence-cli-v0.1.0-x86_64-unknown-linux-gnu.tar.gz"

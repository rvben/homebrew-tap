class ShellyCli < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "6cf846fb57694661b1116ee9a0814f4eb95a086f27198b82916a5b1804497688"
    else
      url "https://github.com/rvben/shelly-cli/releases/download/v#{version}/shelly-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "29c498650e79bee3b1936e1ce3cc1c14ef22de1665a4024e5b90d4848c711f93"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "d76cde3d43e585efa4b601d8e2cfaf0ce17e749d5434f6232350da2579b9f0ef"
    else
      url "https://github.com/rvben/shelly-cli/releases/download/v#{version}/shelly-v#{version}-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "260ff3118bda66ac161952688843f0c14f4cfb23ace82e75b59adc23a6bf6140"
    end
  end
